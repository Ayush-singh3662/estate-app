    ...
    <header className="bg-slate-200 shadow-md">
        <div className="flex justify-between items-center mx-w-6xl mx-auto p-3">
          ...
          <ul className='flex gap-4'>
            ...
            <Link to='/profile'>{currentUser ? <img src={currentUser.avatar} alt='Profile' className='rounded-full h-9 w-9 object-cover' /> : <li className='text-slate-700 hover:underline cursor-pointer'>Sign In</li> }</Link>
          </ul>
        </div>
    </header>
  )
